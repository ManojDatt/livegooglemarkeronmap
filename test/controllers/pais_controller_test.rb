...
class PaisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pai" do
    assert_difference('Pai.count') do
      post pais_url, params: { pai: { CODIGOINT: @pai.CODIGOINT, PA_DESCRIPCION: @pai.PA_DESCRIPCION, PKPAIS: @pai.PKPAIS } }
    end
  ...
  test "should update pai" do
    patch pai_url(@pai), params: { pai: { CODIGOINT: @pai.CODIGOINT, PA_DESCRIPCION: @pai.PA_DESCRIPCION, PKPAIS: @pai.PKPAIS } }
