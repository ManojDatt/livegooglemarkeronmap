...
class MarcasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post marcas_url, params: { marca: { MAR_DESCRIPCION: @marca.MAR_DESCRIPCION, PKMARCA: @marca.PKMARCA } }
    end
  ...
  test "should update marca" do
    patch marca_url(@marca), params: { marca: { MAR_DESCRIPCION: @marca.MAR_DESCRIPCION, PKMARCA: @marca.PKMARCA } }
