...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { ABREVIATURA: @estado.ABREVIATURA, EDO_DESCRIPCION: @estado.EDO_DESCRIPCION, PKESTADO: @estado.PKESTADO, PKPAIS: @estado.PKPAIS, VALOR_OMISION: @estado.VALOR_OMISION } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { ABREVIATURA: @estado.ABREVIATURA, EDO_DESCRIPCION: @estado.EDO_DESCRIPCION, PKESTADO: @estado.PKESTADO, PKPAIS: @estado.PKPAIS, VALOR_OMISION: @estado.VALOR_OMISION } }
